...
function Info() {
  ...
  return (
    <section className="wrapper pt-10 pb-24 bg-primary rounded-3xl">
      ...
      <div className="list flex -z-10 h-[42px] overflow-hidden -ml-[25%]">
      ...
      <div className="w-[900px] max-w-[90%] px-8 py-10 flex flex-col gap-4 mx-auto bg-white rounded-3xl mt-8">
